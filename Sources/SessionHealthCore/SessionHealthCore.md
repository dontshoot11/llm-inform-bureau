...
| `SessionSnapshot.swift` | The input: a session's tokens, window and last turn, what it is waiting on its agent for (nothing, an answer, an answer long overdue) — and, for a subagent, where it came from |
